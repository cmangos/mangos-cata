...
class AuctionBotSeller : public AuctionBotAgent
{
    ...
    private:
        ...
        void        SetPricesOfItem(AHB_Seller_Config& config, uint64& buyp, uint64& bidp, uint32 stackcnt, ItemQualities itemQuality);
...
void AuctionBotSeller::SetPricesOfItem(AHB_Seller_Config& config, uint64& buyp, uint64& bidp, uint32 stackcnt, ItemQualities itemQuality)
{
